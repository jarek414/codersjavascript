...
document.querySelector("#element2").addEventListener("click", function (e) {
  ...
  e.stopPropagation(); // blokujemy wszystko co idzie dalej w drzewie
});
...
document.querySelector("#element5").addEventListener("click", function (e) {
  ...
  e.stopImmediatePropagation(); // tutaj dzieje sie magia blokujemy wszytsko na tym elemencie to co bedzie dalej
});
